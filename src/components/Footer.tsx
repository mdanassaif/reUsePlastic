    ...
    <footer className="bg-black text-gray-400 py-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 px-4 sm:px-6 lg:px-8">
        <div>
          ...
          <p className="mb-4">Our company is committed to recycling plastic and providing high-quality recycled materials for reuse. We strive to make a positive impact on the environment by reducing plastic waste and promoting sustainability.</p>
        </div>
        <div>
        ...
        <div>
          <h2 className="text-white text-lg font-semibold mb-4">Available in</h2>
          <ul>
            <li>India</li>
            <li>Pakistan</li>
            <li>Nepal</li>
      ...
      <p className="text-center text-xs pt-8">© 2024 Reuse Plastic. All rights reserved.</p>
    </footer>
  );
}
