      ...
      <div className="max-w-2xl mx-auto p-4 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <input
            ...
            className="rounded-lg border border-neutral-800 focus:ring-2 focus:ring-teal-500 w-full p-4 bg-neutral-950 placeholder-gray-400" // Updated placeholder color here
            required
          />
          <textarea
            value={message}
